  ...
  return (
    <div className='flex gap-4'>
      ...
      >
        ...
        <IconButton onClick={handleClose} style={{ position: 'absolute', top: 10, right: 10, zIndex: 10 }}>
                    ...
                    <Card>
                      {isPdf ? (
                        ...
                        >
                          ...
                          />
                          <Button size='small' onClick={() => window.open(image.file_url, '_blank')}>
                            View Word File
                          </Button>
                        ...
                        >
                          <CardMedia
                            ...
                            sx={{
                              width: '100%', // full width of container
                              height: 'auto', // auto height to keep aspect ratio
                              // maxHeight: 500, // optional limit
                              objectFit: 'cover', // show full image without crop
                              borderRadius: '10px',
                              // height: 150,
                              // width: 250,
                              // objectFit: 'cover',
      ...
      {openPdf && (
        <Dialog open={openPdf} onClose={() => setOpenPdf(false)} fullWidth maxWidth='md'>
          <DialogContent>
            ...
            <FilePreview fileUrl={selectedPdfUrl} fileType={extension ?? ''} onClose={() => setOpenPdf(false)} />
          </DialogContent>
        </Dialog>
      )}
    </div>
...
const FilePreview = ({ fileUrl, fileType, onClose }: { fileUrl: string; fileType: string; onClose: () => void }) => {
  ...
  return (
    <div style={{ position: 'relative', height: '80vh', width: '100%' }}>
      ...
      {/* Video */}
      {isVideo && (
        <video src={fileUrl} width='100%' height='100%' controls style={{ objectFit: 'cover', borderRadius: '8px' }} />
      )}
