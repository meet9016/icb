...
/**
 * ! If you need data using an API call, uncomment the below API code, update the `process.env.NEXT_PUBLIC_APP_URL` variable in the
...
/* const getStatisticsData = async () => {
  // Vars
  const res = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/pages/widget-examples`)
...
/* const getEcommerceData = async () => {
  // Vars
  const res = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/apps/ecommerce`)
